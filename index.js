module.exports = {
  ...
  rules: {
    ...
    '@gokarma/react-native/no-unused-styles': 'error',

    // split platfrom components
    '@gokarma/react-native/split-platform-components': 'error',

    // detect inline styles
    '@gokarma/react-native/no-inline-styles': 'error',

    // use colors as variable
    '@gokarma/react-native/no-color-literals': 'error',

    // detect raw text
    '@gokarma/react-native/no-raw-text': 'error',

    // detect unnecessary array style
    '@gokarma/react-native/no-single-element-style-arrays': 'error'
  }
}
